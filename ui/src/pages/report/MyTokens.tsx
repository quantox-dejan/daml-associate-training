...
export default function MyTokens() {
  ...
  const offeredToMe = useStreamQueries<TokenOffer, any, any>(TokenOffer, () => [
    { newOwner: party },
  ]).contracts;
  const owners = useStreamQueries<Owner, any, any>(Owner, ownedByMe).contracts;
  const myOwnerRight = owners.length >= 1 ? owners[0] : null;
  const ownerRequests = useStreamQueries<OwnerRequest, any, any>(
    OwnerRequest,
    ownedByMe
  ).contracts;
  ...
  const [ownerRequestProps, setOwnerRequestProps] = useState(
    defaultOwnerRequestProps
  );
  ...
  async function justAccept(ts: TokenOfferTombstone) {
    ...
    ledger.exercise(Owner.AcceptTokenAsNewOwner, myOwnerRight.contractId, {
      offerId: ts.tokenOffer.contractId,
    });
  }
  ...
  const [tokenTombstone, setTokenTombstone] = useState<TokenTombstone | null>(
    null
  );
  const [tokenOfferTombstone, setTokenOfferTombstone] =
    useState<TokenOfferTombstone | null>(null);
  ...
  return (
    <>
              ...
              <TableBody>
                <TableRow className={classes.tableRow}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenTombstone.token.contractId}
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenTombstone.token.templateId}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenTombstone.token.payload.issued}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenTombstone.token.payload.owner}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {formatter(
                      tokenTombstone.token.payload.currency,
                      tokenTombstone.token.payload.lastPrice
                    )}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                    Royalty Rate per 1 {tokenTombstone.token.payload.currency}
                  </TableCell>
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenTombstone.token.payload.royaltyRate}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenTombstone.token.payload.userAdmin}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={7} className={classes.tableCellButton}>
                    <Button
                      ...
                      variant="contained"
                      disabled={
                        tokenTombstone.token.payload.owner !== party ||
                        tokenTombstone.token.templateId !== Token.templateId
                      }
            ...
            <Table size="small">
              <TableBody>
                <TableRow className={classes.tableRow}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenOfferTombstone.tokenOffer.contractId}
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenOfferTombstone.tokenOffer.templateId}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenOfferTombstone.tokenOffer.payload.issued}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenOfferTombstone.tokenOffer.payload.owner}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenOfferTombstone.tokenOffer.payload.newOwner}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {formatter(
                      tokenOfferTombstone.tokenOffer.payload.currency,
                      tokenOfferTombstone.tokenOffer.payload.lastPrice
                    )}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenOfferTombstone.tokenOffer.payload.royaltyRate}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCell}>
                    {tokenOfferTombstone.tokenOffer.payload.userAdmin}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell key={0} className={classes.tableCell}>
                  ...
                  <TableCell key={1} className={classes.tableCellButton}>
                    ...
                    <Button
                      ...
                      variant="contained"
                      disabled={
                        tokenOfferTombstone.tokenOffer.payload.owner !== party
                      }
                      onClick={() => {}}
                    >
                      Claw Back
      ...
      <p>
        {myOwnerRequest
          ? "Awaiting " +
            myOwnerRequest.payload.userAdmin +
            " to Process my Request ('" +
            myOwnerRequest.payload.reason +
            "')."
          : ""}
      </p>
    </>
