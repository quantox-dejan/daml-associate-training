...
export default function UserAdmin() {
  ...
  const owners = useStreamQueries<Owner, any, any>(
    Owner,
    asUserAdmin
  ).contracts;
  ...
  async function justApproveIssuer(issuerRequest: IssuerRequest.CreateEvent) {
    ledger.exercise(
      IssuerRequest.GrantIssuerRights,
      issuerRequest.contractId,
      {}
    );
  }
  ...
  async function justRejectIssuer(issuerRequest: IssuerRequest.CreateEvent) {
    ledger.exercise(
      IssuerRequest.RejectIssuerRequest,
      issuerRequest.contractId,
      {}
    );
  }
  ...
  async function justRejectOwner(ownerRequest: OwnerRequest.CreateEvent) {
    ledger.exercise(
      OwnerRequest.RejectOwnerRequest,
      ownerRequest.contractId,
      {}
    );
  }
